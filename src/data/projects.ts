...
export const projects = [
  {
    name: "Timely - AI Scheduling Assistant (HackPSU Entry)",
    pixelIcon: "M72 56h14v14H72zM72 40h14v14H72zM72 72h14v14H72zM72 104h14v14H72zM72 88h14v14H72zM72 120h14v14H72zM72 152h14v14H72zM72 136h14v14H72zM72 168h14v14H72zM168 56h14v14h-14zM168 40h14v14h-14zM168 72h14v14h-14zM168 104h14v14h-14zM168 88h14v14h-14zM168 120h14v14h-14zM168 152h14v14h-14zM168 136h14v14h-14zM168 168h14v14h-14zM168 184h14v14h-14zM168 200h14v14h-14zM72 184h14v14H72zM72 200h14v14H72zM152 72h14v14h-14zM200 72h14v14h-14zM56 72h14v14H56zM88 72h14v14H88zM184 72h14v14h-14zM200 168h14v14h-14zM184 168h14v14h-14zM40 168h14v14H40zM104 72h14v14h-14zM120 72h14v14h-14zM40 72h14v14H40zM136 72h14v14h-14zM152 168h14v14h-14zM56 168h14v14H56zM88 168h14v14H88zM104 168h14v14H104zM120 168h14v14H120zM136 168h14v14h-14z",
    dateRange: "N/A",
    description: [
      "Powered AI chat system with dual model support for GPT-4o and Gemini via Vercel AI-SDK",
      "Handled OAuth 2.0 user authentication and Google Calendar integration with GCP and NextAuth",
      "Implemented serverless chat storage with Mongoose ODM (MongoDB), allowing for secure CRUD on message logs"
    ],
    techStack: ["AI-SDK", "NextAuth.js", "Google Cloud Platform", "Mongoose ODM", "MongoDB"],
    githubUrl: "https://github.com/JaeMinBird/Timely"
  },
  {
    name: "Ecommerce Site",
    ...
    dateRange: "N/A",
    description: [
      "Automated inventory management in a PostgreSQL database with Prisma ORM hosted on AWS",
      "Secured payment processing with Stripe, handling transactions and order fulfillment",
      "Designed RESTful API endpoints with Next.js App Router, handling product queries and cart operations"
    ],
    techStack: ["PostgreSQL", "Prisma ORM", "AWS", "Stripe", "Next.js", "React", "Tailwind CSS"],
    githubUrl: "https://github.com/JaeMinBird/263Studios"
  },
  {
    ...
    dateRange: "N/A",
    description: [
      "Created retro style portfolio site with React, Next.js, and Typescript, deployed on Vercel",
      "Built responsive, animated UI/UX components with Tailwind CSS and Framer-Motion"
    ],
    techStack: ["React", "Next.js", "Typescript", "Tailwind CSS", "Framer-Motion"],
    githubUrl: "https://github.com/JaeMinBird/Portfolio"
  },
  {
    ...
    dateRange: "N/A",
    description: [
      "Developed block-level storage system in C using JBOD for efficient read/write operations",
      "Implemented LFU caching algorithm to optimize data retrieval and reduce disk access",
      "Integrated TCP networking for remote storage operations over IP networks"
    ],
    techStack: ["C", "TCP/IP", "Linux", "JBOD"],
    githubUrl: "https://github.com/JaeMinBird/VirtualDiskSystem"
  },
  {
    ...
    dateRange: "N/A",
    description: [
      "Designed 5-stage pipelined MIPS CPU in Verilog with integrated control and ALU logic",
      "Simulated CPU behavior in Vivado, verifying pipeline data flow and execution",
      "Synthesized design for xc7z010clg400-1 FPGA, optimizing resource use"
    ],
    techStack: ["Verilog", "Vivado", "FPGA", "MIPS Architecture"],
    githubUrl: "https://github.com/JaeMinBird/MIPS-CPU"
  },
  {
    name: "Club Website",
    pixelIcon: "M200 80h14v14h-14zM200 96h14v14h-14zM184 96h14v14h-14zM184 80h14v14h-14zM200 64h14v14h-14zM168 96h14v14h-14zM168 64h14v14h-14zM152 48h14v14h-14zM136 48h14v14h-14zM120 48h14v14h-14zM56 64h14v14H56zM72 64h14v14H72zM88 48h14v14H88zM104 48h14v14h-14zM56 80h14v14H56zM40 80h14v14H40zM40 96h14v14H40zM40 112h14v14H40zM72 144h14v14H72zM40 160h14v14H40zM104 192h14v14h-14zM88 192h14v14H88zM40 176h14v14H40zM56 160h14v14H56zM56 144h14v14H56zM40 144h14v14H40zM120 192h14v14h-14zM136 192h14v14h-14zM152 192h14v14h-14zM168 192h14v14h-14zM72 48h14v14H72zM72 176h14v14H72zM168 176h14v14h-14zM184 176h14v14h-14zM184 160h14v14h-14zM200 160h14v14h-14zM200 144h14v14h-14zM200 128h14v14h-14z",
    ...
    description: [
      ...
      "Created sign-up form with Node.js and Express.js synced with Google Cloud Platform",
      "Deployed with Nginx on a virtual Ubuntu Server"
    ],
    techStack: ["React", "Node.js", "Express.js", "Nginx", "Google Cloud Platform"], // Skills Demonstrated
